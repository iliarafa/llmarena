...
const grokLogo = "/assets/grok_1764386738517.png";
const chatGptLogo = "/assets/ChatGPT-Logo_1764386066627.png";
const geminiLogo = "/assets/gemini-color_1764386333911.png";
const claudeLogo = "/assets/claude-color_1764386516580.png";
import {
  MODEL_DISPLAY_NAMES,
  MODEL_SHORT_NAMES,
  JUDGE_DISPLAY_NAMES,
      ...
      >
        {AVAILABLE_MODELS.map((model) => {
          ...
          const getIconFilterClasses = () => {
            ...
            if (isDarkLogo) {
              return `dark:grayscale dark:brightness-0 dark:invert ${isSelected ? 'dark:opacity-100' : 'dark:opacity-60'}`;
            }
            return `dark:grayscale dark:brightness-200 dark:contrast-200 ${isSelected ? 'dark:opacity-100' : 'dark:opacity-60'}`;
          };
